<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Tombol create user -->
            <div class="mb-10">
                <a style="background-color: green;" href="{{ route('users.create') }}"
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border px-6 py-4">NRP</th>
                    ...
                    <tbody>
                        @forelse($user as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $item->nrp }}</td>
                                ...
                                <td class="border px-6 py- text-center">
                                    ...
                                    <form action="{{ route('users.edit', $item->id) }}" class="inline-block">
                                        <br>
